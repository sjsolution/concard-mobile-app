        ...
        body:   Stack(
          children: [
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (_)=>CompanyProfileScreen()));
                            },
                            child: Icon(
                              Icons.check,
                              size: 25,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      SizedBox(height: size.height*0.03,),
                      CustomCardInputField(hinttxt: 'Company Name', textInputType: TextInputType.text, controller: controller),
                      SizedBox(height: size.height*0.03,),
                      CustomCardInputField(hinttxt: 'Website', textInputType: TextInputType.text, controller: controller),
                      SizedBox(height: size.height*0.03,),
                      CustomCardInputField(hinttxt: 'Field', textInputType: TextInputType.text, controller: controller),                  
                      SizedBox(height: size.height*0.03,),
                      Container(
                          alignment: Alignment.topLeft,
                          child: Text('Tel',
            ...
            children: [
              ...
              Container(
                  margin: EdgeInsets.only(top: size.height*0.21,left: size.width*0.17),
