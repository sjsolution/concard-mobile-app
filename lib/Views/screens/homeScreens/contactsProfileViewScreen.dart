...
TextEditingController editNotesController= TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          body: Globals.singleCardDetailModal!=null? Stack(
            children: [
                                ...
                                children: [
                                  Column(
                                    children: [
                                      CircleAvatar(
                                        radius: 25,
                                        backgroundImage: NetworkImage(Globals.singleCardDetailModal!.singleCardData!.singleCardUser!.image!=null?Globals.singleCardDetailModal!.singleCardData!.singleCardUser!.image.toString():"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpbz6iSjWmkBiY-Dzq7vWazUn16lI4qiS2Dg&usqp=CAU"),
                                      ),
                                       Text(
              ...
              Container(
                  ...
                  child:Globals.singleCardDetailModal!=null?  ListView(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(editNotesController.text),
                                  ),
                                ),
                              ),
                              // Container(
                              ...
                              Container(
                                ...
                                child:Padding(
                                  ...
                                  children: 
                                    List.generate(
                                  Globals.singleCardDetailModal?.singleCardData?.productSevices?.length == null ? 0:Globals.singleCardDetailModal!.singleCardData!.productSevices!.length ,(index){
                                                      return Padding(
...
void _showEditNotesPopUp(context){
    var size = MediaQuery.of(context).size;
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: ()async{
                                  ...
                                  Globals.addUserRatingModal= await RatingController().addUserRating(addCommentController.text.trim(),myRating.toString() , user!.id.toString());
