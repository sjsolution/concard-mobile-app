...
class UpgradeCompanyPlanScreen extends StatefulWidget {
  ...
  @override
  State<UpgradeCompanyPlanScreen> createState() => _UpgradeCompanyPlanScreenState();
}
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    style: TextStyle(
                     ...
                     Row(
                       children: [
                         Text('Number of Premium Accounts:',
                    style: TextStyle(
                          fontSize:size.height*0.018,
                          fontFamily:"Mbold",
                    ...
                    InkWell(
                      ...
                      child: InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (_)=>ManageCompanyPremiumPlan()));
                        },
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
