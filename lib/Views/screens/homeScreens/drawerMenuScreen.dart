        ...
        child: ListView(
          ...
          children: [
            ...
            SizedBox(height: size.height*0.02,),
              ...
              globals.isAccespremium!? InkWell(
                 onTap:(){
                         ...
                         child: Row(
                           ...
                           children: [
                            ...
                            Text('Access My Premium',
                             ...
                             Icon(Icons.arrow_forward_ios_sharp,size: size.height*0.02,color: bckgrnd,)
                           ],
                         ),
                       ),
                   ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Now you're discoverable to Near by Contacts",
                  style: TextStyle(
                    fontSize: size.height*0.015,
                    fontFamily: "Stf",
                    color: infocolor
                              ...
                              children: [
                                InkWell(
                                  ...
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Image.asset(faq_icon,height: size.height*0.035,),
                                      Text('FAQs',
                                      style: TextStyle(
                                        fontSize: size.height*0.015,
                                        fontFamily: "Msemibold"
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: size.width*0.02,),
                               Text('support@concard.io',style: TextStyle(
                                fontSize: size.height*0.018,
                              fontFamily: "Msemibold",
                              color: signupclor_dark
                              ),),
