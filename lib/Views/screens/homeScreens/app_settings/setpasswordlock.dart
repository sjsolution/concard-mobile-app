                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(30), borderSide: BorderSide(color: Colors.transparent)),
                      ),
                    ),
                  ),
                  SizedBox(
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: Center(
                                            child: Text(
                                          'OK',
                                          style: TextStyle(fontSize: size.height * 0.015, fontFamily: 'MBold', color: signupclor_dark),
                                        )),
                                      ),
                                    ),
                                  ],
