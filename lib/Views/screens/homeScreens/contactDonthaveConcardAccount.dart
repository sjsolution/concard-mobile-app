...
class ContactDontHaveConcardAccountViewScreen extends StatefulWidget {
  ContactDontHaveConcardAccountViewScreen(
      {Key? key,
      required this.id,
     })
      : super(key: key);
  ...
  String? noteId;
  @override
  State<ContactDontHaveConcardAccountViewScreen> createState() =>
      _ContactDontHaveConcardAccountViewScreenState();
}

class _ContactDontHaveConcardAccountViewScreenState
    extends State<ContactDontHaveConcardAccountViewScreen> {
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Contrary to popular belief, Lorem Ipsum is not simply random next',
                                      style: TextStyle(
                              ...
                              InkWell(
                                onTap: () {
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (_) =>
                                              InviteContactToBecameConcardMember()));
                                },
                                child: Column(
                                  children: [
                                    Container(
                        ...
                        Column(
                          children: [
                            ...
                            PrettyQr(
                              ...
                              data: '${singleCardData!.id.toString() ?? "0"}',
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  phoneNumberToShow!=null?phoneNumberToShow.toString():'',
                                  style: TextStyle(
                                    fontSize: size.height * 0.015,
                                    color: signupclor_dark,
                                    fontFamily: "Mbold",
                                ...
                                SizedBox(
                                  width: size.width * 0.02,
                                      ...
                                      Column(
                                        children: [
                                          Text(
                                          emailToShow!=null?  emailToShow.toString() : '',
                                            style: TextStyle(
