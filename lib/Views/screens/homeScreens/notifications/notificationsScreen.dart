              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: size.height*0.02,left: size.width*0.04),
                    child: Container(
                      child: Text('Wednesday, 24 February 2021',
                        style: TextStyle(
                              ...
                              children: [
                                Row(crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    Text(' has updated Profile pic',style: TextStyle(
                                        fontSize: size.height*0.017,
                                        fontFamily: 'Msemibold'
                                    ),),
                                    Spacer(),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('User 1 has started new role/position',style: TextStyle(
                                          fontSize: size.height*0.018,
                                          fontFamily: 'Msemibold'
                                      ),),
                                      Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Container(
                                      ...
                                      // margin: EdgeInsets.only(left: size.width*0.04),
                                      alignment: Alignment.center,
                                      child: Text('Say Congrats', style: TextStyle(
                                          color: gradientgreen,
                                          fontSize: size.height*0.015,
                                          fontFamily: 'Msemibold'
                                      ),),
        ...
        builder: (BuildContext bc) {
          return StatefulBuilder(
            builder: (context, setSte) {
              ...
              new ListTile(
              leading:SvgPicture.asset(recyclebin_icon,color: crs_clr,),
              title: new Text('Delete notificaton',style: TextStyle(
              fontFamily: 'Msemibold',
                fontSize: size.height*0.018,
                color: crs_clr
              ),),
