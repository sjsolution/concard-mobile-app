...
class IndividualPremiumScreen extends StatefulWidget {
  IndividualPremiumScreen({Key? key}) : super(key: key);

  @override
  State<IndividualPremiumScreen> createState() => _IndividualPremiumScreenState();
}

class _IndividualPremiumScreenState extends State<IndividualPremiumScreen> {
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text('CONCARD Premium',style: TextStyle(
                          fontFamily: "MBold",
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: size.height*0.03,),
                     Text('Premium membership: \$ 5/month',
                    style: TextStyle(
                      fontSize:size.height*0.018,
                      fontFamily:"Mbold",
                      
                    ),),
                     Text('Next billing date: Apr 16,2022',
                    style: TextStyle(
                      fontSize:size.height*0.018,
                      fontFamily:"Stf",
                    ...
                    InkWell(
                      ...
                      child: InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (_)=>ManageMembershipScreen()));
                        },
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                        ...
                        Icon(Icons.arrow_forward_ios,size: size.height*0.02,color: gradientgreen,)
                          ],
                        ),
                      ),
                    ),
                    ...
                    Text('Upgrade your Premium Membership',
                    style: TextStyle(
                      fontSize:size.height*0.018,
                      fontFamily:"Mbold",
                      color: signupclor_light
