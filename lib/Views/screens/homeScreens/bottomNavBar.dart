                                            ...
                                            child: Container(
                                                ...
                                                child: Column(
                                                  children: <Widget>[
                                                    Container(
                                                      child: Padding(
                                                        padding:  EdgeInsets.only(right: size.width*0.04,top:size.height*0.02,left: size.width*0.04),
                                                        child: Row(
                                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                          children: [
                                                            Container(
                                                    ...
                                                    SizedBox(height: 15,),
                                                    Image.asset(cnctbynfc_icon,height: 50,),
                                                    SizedBox(height: 15,),
                                                    Padding(
                                                      padding: const EdgeInsets.only(left: 10.0),
                                                      child: Row(
                                                        children: [
                                                          Image.asset(guidline_icon,height: 10,),
                                                          SizedBox(width: 5,),
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Column(
                                                                              children: [
                                                                                ...
                                                                                Text('Assem Yamak',style: TextStyle(
                                                                                    fontFamily: 'MBold',
                                                                                    fontSize: size.height*0.015
                                                                                ),),
                                                                                Text('6274239',style: TextStyle(
                                                                                    fontFamily: 'Stf',
                                                                                    fontSize: size.height*0.015
                                                                                ),),
                                                                              ],
