          ...
          Container(
            ...
            child:    Padding(
              ...
              child: SmoothPageIndicator(
                ...
                count:  3,
                effect: WormEffect(),
                onDotClicked: (index)=>_controller.animateToPage(index, duration: Duration( milliseconds:200 ), curve: Curves.bounceOut),
          ...
          Container(
            child: PageView.builder(
              ...
              itemBuilder: (context,position){
                return sIndex==0?IndividualDetail():sIndex==1?NumberVerification():CodeVerification();
              },
            ),
          ),
        ],
