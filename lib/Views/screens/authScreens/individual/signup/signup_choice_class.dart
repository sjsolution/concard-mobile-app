...
import 'package:concard/Views/screens/authScreens/individual/signup/homeScreen.dart';
...
class SignupChoiceClass extends StatelessWidget {
  const SignupChoiceClass({Key? key}) : super(key: key);
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () {
                      ...
                      Navigator.pushNamed(context, '/indiBasic');
                    },
                    child: CustomButton(
                        text: "Individual",
                ...
                GestureDetector(
                  onTap: () {
                    Globals.userType='2';
                    Navigator.pushNamed(context, '/companyBusinessType');
                  },
                  child: CustomButton(
                      text: "Company",
                      color1: btnclr.withOpacity(0.3),
