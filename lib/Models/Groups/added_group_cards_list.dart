class AddedCardsToGroupListModal {
  final int? code;
  final String? message;
  final List<AddedGroupCardsListData>? addedGroupCardsListData;

  AddedCardsToGroupListModal({
    this.code,
    this.message,
    this.addedGroupCardsListData,
  });

  AddedCardsToGroupListModal.fromJson(Map<String, dynamic> json)
    : code = json['code'] as int?,
      message = json['message'] as String?,
      addedGroupCardsListData = (json['data'] as List?)?.map((dynamic e) => AddedGroupCardsListData.fromJson(e as Map<String,dynamic>)).toList();

  Map<String, dynamic> toJson() => {
    'code' : code,
    'message' : message,
    'data' : addedGroupCardsListData?.map((e) => e.toJson()).toList()
  };
}

class AddedGroupCardsListData {
  final int? id;
  final int? userId;
  ...
  AddedGroupCardsListData.fromJson(Map<String, dynamic> json)
    : id = json['id'] as int?,
