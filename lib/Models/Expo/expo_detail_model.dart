...
class ExpoDetailModel {
  final int? code;
  final String? message;
  final ExpoDetailData? expoDetaildata;
  ...
  ExpoDetailModel.fromJson(Map<String, dynamic> json)
    : code = json['code'] as int?,
      message = json['message'] as String?,
      expoDetaildata = (json['data'] as Map<String,dynamic>?) != null ? ExpoDetailData.fromJson(json['data'] as Map<String,dynamic>) : null;

  Map<String, dynamic> toJson() => {
    'code' : code,
    'message' : message,
    'data' : expoDetaildata?.toJson()
  };
}

class ExpoDetailData {
  final int? id;
  final int? userId;
  final String? badgeName;
  final String? badgeType;
  ...
  ExpoDetailData.fromJson(Map<String, dynamic> json)
    : id = json['id'] as int?,
...
class ExpoDetailPivot {
  ...
  ExpoDetailPivot.fromJson(Map<String, dynamic> json)
    : expobadgeId = json['expobadge_id'] as int?,
